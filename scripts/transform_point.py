...
class TranformPoints(Node):
    ...
    def __init__(self):
        ...
        self.point_in_robot_frame = None
        # Basic ROS stuff
        timer_frequency = 1
    ...
    def timer_callback(self):
        ...
        if self.point_in_robot_frame is None:
            return
        ...
        try:
            ...
            point_in_map_frame = tfg.do_transform_point(self.point_in_robot_frame, trans)
